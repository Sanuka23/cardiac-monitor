...
class DashboardScreen extends StatelessWidget {
              ...
              GlassCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _statusChip(context, 'Sensor', v.sensorOk, PhosphorIconsLight.cpu),
                        const SizedBox(width: 8),
                        _statusChip(context, 'WiFi', v.wifiReady, PhosphorIconsLight.wifiHigh),
                        const SizedBox(width: 8),
                        _statusChip(
                            context, 'ECG', !v.ecgLeadOff, PhosphorIconsLight.pulse),
                        const SizedBox(width: 8),
                        _statusChip(context, 'API', v.apiReady, PhosphorIconsLight.cloud),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _statusChip(BuildContext context, String label, bool ok, IconData icon) {
    final color = ok ? const Color(0xFF4CAF50) : AppTheme.textSecondary(context);
    return Expanded(
      child: Container(
